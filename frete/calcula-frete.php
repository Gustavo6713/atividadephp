...
<body>
    <!-- Se o valor do pedagio for maior que 100,00 imprimir em vermelho -->
    <?php
        if($custoPedagio > 100) {
    ?>
        <h1 style="color: red">O valor total dos pedagios é: R$ <?= number_format($custoPedagio, 2, ",", ".") ?> </h1>
    <?php
        } else{
    ?>
        <h1>O valor total dos pedagios é: R$ <?= number_format($custoPedagio, 2, ",", ".") ?> </h1>
    <?php
        }
    ?>
